document.addEventListener("DOMContentLoaded", function() {
    document.getElementById("extract-button").addEventListener("click", async () => {
      try {
        ...
        pred_score = 6.32004967e+00*awl(extractedText) - 4.70656069e-02*asl(extractedText) + 3.30719853e-04*polysll_cnt(extractedText) - 7
        // console.log(pred_score);
        var outStr = `<span style="color:red">Readibility Score:</span>${pred_score} `
